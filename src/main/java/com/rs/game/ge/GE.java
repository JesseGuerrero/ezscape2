...
public class GE {
    ...
    public static ButtonClickHandler mainInterface = new ButtonClickHandler(105, e -> {
        ...
        switch (e.getComponentId()) {
            ...
            case 177 ->
                    e.getPlayer().sendInputInteger("Enter desired price", price -> e.getPlayer().getVars().setVar(VAR_FOR_PRICE_TEXT, Utils.clampI(price, 0, Integer.MAX_VALUE)));
            ...
            default ->
                    Logger.debug(GE.class, "mainInterface", "Unhandled GE button: " + e.getComponentId() + ", " + e.getSlotId());
