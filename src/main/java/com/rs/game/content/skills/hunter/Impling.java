...
public class Impling extends NPC {
    ...
    public static void initSpawns() {
        ...
        Tile[] STATIC_OVERWORLD_LOW_IMPLING_SPAWNS = new Tile[] { Tile.of(2481, 4442, 0), Tile.of(2354, 3608, 0), Tile.of(2279, 3188, 0), Tile.of(2455, 3084, 0), Tile.of(2567, 3384, 0), Tile.of(2784, 3463, 0), Tile.of(2967, 3411, 0), Tile.of(3093, 3238, 0), Tile.of(3283, 3428, 0), Tile.of(3278, 3155, 0), Tile.of(1174, 4516, 0), Tile.of(1181, 4507, 0), Tile.of(1186, 4511, 0), Tile.of(1197, 4511, 0), Tile.of(1192, 4508, 0) };
