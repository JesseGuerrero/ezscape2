...
public class Smithing extends PlayerAction {
	...
	public enum Smithable {
		...
		IRON_CHAINBODY(Slot.CHAINBODY, new Item(1101, 1), 26, 75.0, new Item(2351, 3)),
		BRONZE_CHAINBODY(Slot.CHAINBODY, new Item(1103, 1), 11, 37.0, new Item(2349, 3)),
		STEEL_CHAINBODY(Slot.CHAINBODY, new Item(1105, 1), 41, 112.0, new Item(2353, 3)),
		MITHRIL_CHAINBODY(Slot.CHAINBODY, new Item(1109, 1), 61, 150.0, new Item(2359, 3)),
		ADAMANT_CHAINBODY(Slot.CHAINBODY, new Item(1111, 1), 81, 187.0, new Item(2361, 3)),
		RUNE_CHAINBODY(Slot.CHAINBODY, new Item(1113, 1), 96, 225.0, new Item(2363, 3)),
		IRON_PLATEBODY(Slot.PLATEBODY, new Item(1115, 1), 33, 125.0, new Item(2351, 5)),
		BRONZE_PLATEBODY(Slot.PLATEBODY, new Item(1117, 1), 18, 62.0, new Item(2349, 5)),
		STEEL_PLATEBODY(Slot.PLATEBODY, new Item(1119, 1), 48, 187.0, new Item(2353, 5)),
		MITHRIL_PLATEBODY(Slot.PLATEBODY, new Item(1121, 1), 68, 250.0, new Item(2359, 5)),
		ADAMANT_PLATEBODY(Slot.PLATEBODY, new Item(1123, 1), 88, 312.0, new Item(2361, 5)),
		RUNE_PLATEBODY(Slot.PLATEBODY, new Item(1127, 1), 99, 375.0, new Item(2363, 5)),
