...
public class Doors {
	...
	public static ObjectClickHandler handleDoors = new ObjectClickHandler(new Object[] { 1531, "Door", "Throne Room Door", "Magic door", "Doorway", "Sturdy door", "Bamboo Door", "Long hall door", "Castle door", "Heavy door", "Gate", "Large door", "Metal door", "City gate", "Red door", "Orange door", "Yellow door", "Cell door", "Cell Door", "Wall", "Storeroom Door", "Solid bronze door", "Solid steel door", "Solid black door", "Solid silver door" }, e -> handleDoor(e.getPlayer(), e.getObject()));

	public static ObjectClickHandler handleLeftHandedDoors = new ObjectClickHandler(new Object[] { 22921 }, e -> handleLeftHandedDoor(e.getPlayer(), e.getObject()));

	public static ObjectClickHandler handleInvertedDoors = new ObjectClickHandler(new Object[] { 1531 }, ObjectType.WALL_INTERACT, e -> handleDoor(e.getPlayer(), e.getObject(), 1));
	...
	public static ObjectClickHandler handleDoubleDoors = new ObjectClickHandler(new Object[] { 704, 707, 708, 709, 1516, 1517, 1519, 1520, 1542, 1543, 1544, 1545, 1560, 1561, 1596, 1597, 2199, 2200, 2255, 2256, 2259, 2260, 2546, 2547, 2548, 2549, 2552, 2553, 2896, 2897, 2391, 2392, 2912, 2913, 2922, 2923, 3020, 3021, 3022, 3023, 2673, 2674, 2786, 2787, 2788, 2789, 3506, 3507, 4423, 4424, 4425, 4426, 4427, 4428, 4429, 4430, 4487, 4491, 4490, 4492, 4629, 4630, 4631, 4632, 4633, 4634, 4963, 4964, 5183, 5186, 5187, 5188,
			...
			e -> handleDoubleDoor(e.getPlayer(), e.getObject()));

	public static ObjectClickHandler handleInvertedDoubles = new ObjectClickHandler(new Object[] { 37000, 37003 }, e -> handleDoubleDoor(e.getPlayer(), e.getObject(), true));
	...
	public static ObjectClickHandler handleInPlaceSingleDoors = new ObjectClickHandler(new Object[] { 4250, 4251, 5887, 5888, 5889, 5890, 5891, 5893, 64833, 64834, 65386, 65387, 65573, 65574, 68977, 68978, 68983 }, e -> handleInPlaceSingleDoor(e.getPlayer(), e.getObject()));

	public static ObjectClickHandler handleInPlaceDoubleDoors = new ObjectClickHandler(new Object[] { 6553, 6555 }, e -> handleInPlaceDoubleDoor(e.getPlayer(), e.getObject()));
	...
	public static ObjectClickHandler handleWasteMyTimeDoor1 = new ObjectClickHandler(new Object[] { 1591 }, new Tile[] { Tile.of(2794, 3199, 0) }, e -> handleDoor(e.getPlayer(), e.getObject()));
