...
public class Doors {
	...
	public static ObjectClickHandler handleDoors = new ObjectClickHandler(new Object[] { 1531, "Door", "Throne Room Door", "Magic door", "Doorway", "Sturdy door", "Bamboo Door", "Long hall door", "Castle door", "Heavy door", "Gate", "Large door", "Metal door", "City gate", "Red door", "Orange door", "Yellow door", "Cell door", "Cell Door", "Wall", "Storeroom Door", "Solid bronze door", "Solid steel door", "Solid black door", "Solid silver door" }, e -> handleDoor(e.getPlayer(), e.getObj()));

	public static ObjectClickHandler handleLeftHandedDoors = new ObjectClickHandler(new Object[] { 22921 }, e -> handleLeftHandedDoor(e.getPlayer(), e.getObj()));

	public static ObjectClickHandler handleInvertedDoors = new ObjectClickHandler(new Object[] { 1531 }, ObjectType.WALL_INTERACT, e -> handleDoor(e.getPlayer(), e.getObj(), 1));

	public static ObjectClickHandler handleDoubleDoors = new ObjectClickHandler(new Object[] { 704, 707, 708, 709, 1516, 1517, 1519, 1520, 1542, 1543, 1544, 1545, 1560, 1561, 1596, 1597, 2199, 2200, 2255, 2256, 2259, 2260, 2546, 2547, 2548, 2549, 2552, 2553, 2896, 2897, 2391, 2392, 2912, 2913, 2922, 2923, 3020, 3021, 3022, 3023, 2673, 2674, 2786, 2787, 2788, 2789, 3506, 3507, 4423, 4424, 4425, 4426, 4427, 4428, 4429, 4430, 4487, 4491, 4490, 4492, 4629, 4630, 4631, 4632, 4633, 4634, 4963, 4964, 5183, 5186, 5187, 5188,
			...
			24373, 24374, 25638, 25639, 25640, 25641, 25788, 25789, 25790, 25791, 25813, 25814, 25815, 25816, 25825, 25826, 25827, 25828, 26081, 26082, 26083, 26084, 26114, 26115, 27851, 27852, 27853, 27854, 28690, 28691, 28692, 28693, 29315, 29316, 29317, 29318, 31814, 31815, 31816, 31817, 31820, 31821, 31822, 31823, 31824, 31825, 31826, 31827, 31829, 31830, 31831, 31832, 31833, 31834, 31841, 31844, 34819, 34820, 34822, 34823, 34825, 34826, 34827, 34828, 36315, 36316, 36317, 36318, 36999, 37002, 39975, 39976, 39978, 39979, 41131, 41132, 41133, 41134, 41174, 41175, 41178, 41179, 45964, 45965,
			45966, 45967, 47240, 47241, 48938, 48939, 48940, 48941, 48942, 48943, 48944, 48945, 52176, 52183, 52381, 52313, 52382, 52315, 53671, 53672, 53674, 53675, 59958, 59961, 61051, 61052, 61053, 61054, 64835, 64837, 66599, 66601, 66938, 66940, 66941, 66942 },
			e -> handleDoubleDoor(e.getPlayer(), e.getObj()));

	public static ObjectClickHandler handleInvertedDoubles = new ObjectClickHandler(new Object[] { 37000, 37003 }, e -> handleDoubleDoor(e.getPlayer(), e.getObj(), true));

	public static ObjectClickHandler handleInvertedDoublesYanille = new ObjectClickHandler(new Object[] { 1517, 1520 }, new Tile[] { Tile.of(2561, 3099, 0), Tile.of(2561, 3098, 0) }, e -> handleDoubleDoor(e.getPlayer(), e.getObj(), true));

	public static ObjectClickHandler handleGates = new ObjectClickHandler(new Object[] { 1551, 1552, 1553, 1556, 2306, 2313, 2320, 2344, 2261, 2262, 2438, 2439, 3015, 3016, 3725, 3726, 4311, 4312, 7049, 7050, 7051, 7052, 15510, 15511, 15512, 15513, 15514, 15515, 15516, 15517, 34777, 34778, 34779, 34780, 36912, 36913, 36914, 36915, 37351, 37352, 37353, 37354, 45206, 45207, 45208, 45209, 45210, 45211, 45212, 45213 }, e -> handleGate(e.getPlayer(), e.getObj()));

	public static ObjectClickHandler handleInPlaceSingleDoors = new ObjectClickHandler(new Object[] { 4250, 4251, 5887, 5888, 5889, 5890, 5891, 5893, 64833, 64834, 65386, 65387, 65573, 65574, 68977, 68978, 68983 }, e -> handleInPlaceSingleDoor(e.getPlayer(), e.getObj()));

	public static ObjectClickHandler handleInPlaceDoubleDoors = new ObjectClickHandler(new Object[] { 6553, 6555 }, e -> handleInPlaceDoubleDoor(e.getPlayer(), e.getObj()));
	...
	public static ObjectClickHandler handleKeyDoors = new ObjectClickHandler(new Object[] { 1804, 2623 }, e -> {
	...
	public static ObjectClickHandler handleWasteMyTimeDoor1 = new ObjectClickHandler(new Object[] { 1591 }, new Tile[] { Tile.of(2794, 3199, 0) }, e -> handleDoor(e.getPlayer(), e.getObj()));

	public static ObjectClickHandler handleWasteMyTimeDoor2 = new ObjectClickHandler(new Object[] { 21401 }, e -> e.getPlayer().sendMessage("The door won't budge."));
	...
	public static void handleClosedDoor(Player player, GameObject object) {
        ...
        adjusted = switch (rotation) {
            case 0 -> adjusted.transform(open ? -1 : 1, 0, 0);
            case 1 -> adjusted.transform(0, open ? 1 : -1, 0);
            case 2 -> adjusted.transform(open ? 1 : -1, 0, 0);
            case 3 -> adjusted.transform(0, open ? -1 : 1, 0);
            default -> adjusted;
        };
	...
	public static void handleInPlaceDoubleDoor(Player player, GameObject object) {
		ObjectDefinitions openedDef = ObjectDefinitions.getDefs(DoorPair.getOpposingDoor(player, object));
		boolean tempMove = isTempMove(openedDef);
		GameObject[] doors = getNearby(player, object, (t1, t2) -> t1.getY() > t2.getY(), object.getTile().transform(0, 1, 0), object.getTile().transform(0, -1, 0));
		if (doors == null)
	...
	public static void handleDoubleDoor(Player player, GameObject object, boolean invert) {
		...
		switch (rotation) {
			case 0:
				if (tempMove) {
					World.spawnObjectTemporary(new GameObject(doors[0], 83), 2, true);
					World.spawnObjectTemporary(new GameObject(doors[1], 83), 2, true);
	...
	public static void handleGate(Player player, GameObject object) {
		...
		switch (rotation) {
			case 0:
				if (open)
					gates = getNearby(player, object, (t1, t2) -> t1.getY() > t2.getY(), object.getTile().transform(0, -1, 0), object.getTile().transform(0, 1, 0));
				else
					gates = getNearby(player, object, (t1, t2) -> t1.getX() < t2.getX(), object.getTile().transform(-1, 0, 0), object.getTile().transform(1, 0, 0));
				if (gates == null) {
					handleDoor(player, object);
					return;
				}
				if (tempMove) {
					World.spawnObjectTemporary(new GameObject(gates[0], 83), 2, true);
					World.spawnObjectTemporary(new GameObject(gates[1], 83), 2, true);
